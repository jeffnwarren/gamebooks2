...
const flags = [
  ["stray replacement/control glyph", /[\u00ef\u00bf\u00bd\u00c3\u00c2\u00a7\u20ac]/g, 7],
  ["at-sign inside prose", /[A-Za-z]@[A-Za-z]|@[A-Za-z]{2,}/g, 5],
  ["common bad turn word", /\b(?:tum|hurn|hirn|hum|hon|faim|fiirn|tumi|tiurn|furn|burn|bun|humm)\s+(?:to|lo|te|bo|eo|fo)?\s*[0-9OoQIiLlAaEeSsBbGgqQjJzZyY$%(){}.,'"\u00a7]{1,6}\b/gi, 4],
  ["broken stat word", /\b(?:sraMINA|srAMINA|srAMrNA|sTaMINA|sxILL|sKIL1|SKIL1|sxi1|rArrrr|sTamMINA|5TAMINA|STAMINAS|Luek|Lueky|LucK|LuCK)\b/g, 4],
  ["common OCR word", /\b(?:vour|vou|yau|yout|lhe|ihe|thal|fom|fron|writen|belore|tuming|tums|tumed|looky|mear|nat|bo|te|lo|ta|ar|fer|bat|mana8e|ro11)\b/gi, 3],
  ...
  ["joined prose token", /\b(?:tothe|orthe|oryou|Ifyou|itis|itagain)\b/gi, 3],
  ...
  ["page-art residue", /\b(?:eee|SSS|OOO|i_i_i|Wh Ht|a aca a|ooooSEEOEOEOEO)\b/g, 3]
];
