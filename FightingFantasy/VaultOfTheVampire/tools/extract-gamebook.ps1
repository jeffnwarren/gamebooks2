param(
    [string]$PdfPath = "source\altered FF38 Vault of the Vampire.pdf",
...
[void]$js.AppendLine("  title: `"Vault of the Vampire`",")
[void]$js.AppendLine("  sourcePdf: `"../source/altered FF38 Vault of the Vampire.pdf`",")
[void]$js.AppendLine("  coverImage: `"../source/vaultofthevampire.jpg`",")
